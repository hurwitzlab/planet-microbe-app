    ...
    div [ class "fade-in" ]
        ...
        , div [ class "container marketing" ]
            [ div [ class "row", style "color" "#5a5a5a" ]
                ...
                , div [ class "col-lg-4" ]
                    [ img [ alt "Phase 3 Image", class "rounded-circle", attribute "height" "140", src "assets/images/earthcube-projects.jpg", attribute "loading" "lazy", attribute "width" "140" ] []
                    , h2 [] [ text "Phase 3" ]
            ...
            , div [ class "row" ]
                [ div [ class "col" ]
                    [ div [ class "alert alert-info" ]
                        [ p [] [ text "To cite Planet Microbe: " ]
                        , p [ class "font-italic" ]
                            [ text "Alise J Ponsero, Matthew Bomhoff, Kai Blumberg, Ken Youens-Clark, Nina M Herz, Elisha M Wood-Charlson, Edward F Delong, Bonnie L Hurwitz, Planet Microbe: a platform for marine microbiology to discover and analyze interconnected ‘omics and environmental data, Nucleic Acids Research, gkaa637, "
                            , a [ href "https://doi.org/10.1093/nar/gkaa637", target "_blank" ] [ text "https://doi.org/10.1093/nar/gkaa637" ]
                            ]
                        ]
                    ]
                ]
            ...
            , div [ class "row featurette" ]
                ...
                , div [ class "col-md-5" ]
                    [ a [ href "https://www.planetmicrobe.org/#/search" ]
                        [ img [ class "border shadow featurette-image img-fluid mx-auto", src "assets/images/search-demo.gif", attribute "loading" "lazy", alt "Animated GIF screen capture" ] []
                        ]
                    ]
                ]
            , hr [ class "featurette-divider" ] []
